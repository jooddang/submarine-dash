...
import type { SeededRNG } from "./pvpTypes";
import * as Constants from "../constants";

// --- Mulberry32 seeded PRNG ---
// Fast, deterministic, good distribution. Returns values in [0, 1).
...
// --- Deterministic background entity spawning ---
...
// --- Generate initial platforms (ground level) ---
...
// --- Generate next world segment (platform + items) ---
// Mirrors Game.tsx lines 1660-1798 but uses seeded RNG.
export function generateNextSegment(
  ...
  // Item spawning (only on non-gap platforms)
  if (!isGap) {
